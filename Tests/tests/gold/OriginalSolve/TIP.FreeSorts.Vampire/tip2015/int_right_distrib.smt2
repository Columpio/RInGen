...
tff(f8648,plain,(
  $false),
  inference(subsumption_resolution,[],[f8647,f7809])).
tff(f7809,plain,(
  sP12('P_1'(zero_0),'P_1'(succ_0(zero_0)),'N_0'(zero_0),'N_0'(zero_0))),
  inference(unit_resulting_resolution,[],[f330,f7720,f201])).
tff(f201,plain,(
  ( ! [X4 : 'Integer_0()',X0 : 'Integer_0()',X7 : 'Integer_0()',X5 : 'Integer_0()',X3 : 'Integer_0()'] : (sP12(X5,X3,X0,X7) | ~plus_1(X3,X5,X4) | ~times_1(X4,X7,X0)) )),
  inference(cnf_transformation,[],[f201_D])).
tff(f201_D,plain,(
  ( ! [X7,X0,X3,X5] : (( ! [X4] : (~plus_1(X3,X5,X4) | ~times_1(X4,X7,X0)) ) <=> ~sP12(X5,X3,X0,X7)) )),
...
tff(f34,axiom,(
  ...
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/tip2015/int_right_distrib.smt2',unknown)).
tff(f569,plain,(
...
tff(f8647,plain,(
  ~sP12('P_1'(zero_0),'P_1'(succ_0(zero_0)),'N_0'(zero_0),'N_0'(zero_0))),
  inference(unit_resulting_resolution,[],[f7770,f8639,f202])).
tff(f202,plain,(
  ( ! [X0 : 'Integer_0()',X7 : 'Integer_0()',X5 : 'Integer_0()',X3 : 'Integer_0()',X1 : 'Integer_0()'] : (~sP12(X5,X3,X0,X7) | ~sP11(X5,X1,X0,X7) | ~sP10(X3,X1,X0)) )),
  inference(general_splitting,[],[f200,f201_D])).
tff(f200,plain,(
  ( ! [X4 : 'Integer_0()',X0 : 'Integer_0()',X7 : 'Integer_0()',X5 : 'Integer_0()',X3 : 'Integer_0()',X1 : 'Integer_0()'] : (~times_1(X4,X7,X0) | ~plus_1(X3,X5,X4) | ~sP10(X3,X1,X0) | ~sP11(X5,X1,X0,X7)) )),
  inference(general_splitting,[],[f198,f199_D])).
tff(f199,plain,(
  ( ! [X6 : 'Integer_0()',X0 : 'Integer_0()',X7 : 'Integer_0()',X5 : 'Integer_0()',X1 : 'Integer_0()'] : (sP11(X5,X1,X0,X7) | ~times_1(X5,X6,X0) | ~plus_1(X1,X6,X7)) )),
  inference(cnf_transformation,[],[f199_D])).
tff(f199_D,plain,(
  ( ! [X7,X0,X1,X5] : (( ! [X6] : (~times_1(X5,X6,X0) | ~plus_1(X1,X6,X7)) ) <=> ~sP11(X5,X1,X0,X7)) )),
  introduced(general_splitting_component_introduction,[new_symbols(naming,[sP11])])).
tff(f198,plain,(
  ( ! [X6 : 'Integer_0()',X4 : 'Integer_0()',X0 : 'Integer_0()',X7 : 'Integer_0()',X5 : 'Integer_0()',X3 : 'Integer_0()',X1 : 'Integer_0()'] : (~plus_1(X1,X6,X7) | ~times_1(X5,X6,X0) | ~times_1(X4,X7,X0) | ~plus_1(X3,X5,X4) | ~sP10(X3,X1,X0)) )),
  inference(general_splitting,[],[f175,f197_D])).
tff(f197,plain,(
  ( ! [X2 : 'Integer_0()',X0 : 'Integer_0()',X3 : 'Integer_0()',X1 : 'Integer_0()'] : (~times_1(X2,X1,X0) | ~diseqInteger_0(X2,X3) | sP10(X3,X1,X0)) )),
  inference(cnf_transformation,[],[f197_D])).
tff(f197_D,plain,(
  ( ! [X0,X1,X3] : (( ! [X2] : (~times_1(X2,X1,X0) | ~diseqInteger_0(X2,X3)) ) <=> ~sP10(X3,X1,X0)) )),
  introduced(general_splitting_component_introduction,[new_symbols(naming,[sP10])])).
tff(f175,plain,(
  ( ! [X6 : 'Integer_0()',X4 : 'Integer_0()',X2 : 'Integer_0()',X0 : 'Integer_0()',X7 : 'Integer_0()',X5 : 'Integer_0()',X3 : 'Integer_0()',X1 : 'Integer_0()'] : (~diseqInteger_0(X2,X3) | ~plus_1(X1,X6,X7) | ~times_1(X2,X1,X0) | ~times_1(X5,X6,X0) | ~times_1(X4,X7,X0) | ~plus_1(X3,X5,X4)) )),
  inference(cnf_transformation,[],[f119])).
tff(f119,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Integer_0()',X2 : 'Integer_0()',X3 : 'Integer_0()',X4 : 'Integer_0()',X5 : 'Integer_0()',X6 : 'Integer_0()',X7 : 'Integer_0()'] : (~diseqInteger_0(X2,X3) | ~plus_1(X1,X6,X7) | ~times_1(X2,X1,X0) | ~times_1(X5,X6,X0) | ~times_1(X4,X7,X0) | ~plus_1(X3,X5,X4))),
  inference(ennf_transformation,[],[f89])).
tff(f89,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Integer_0()',X2 : 'Integer_0()',X3 : 'Integer_0()',X4 : 'Integer_0()',X5 : 'Integer_0()',X6 : 'Integer_0()',X7 : 'Integer_0()'] : ~(diseqInteger_0(X2,X3) & plus_1(X1,X6,X7) & times_1(X2,X1,X0) & times_1(X5,X6,X0) & times_1(X4,X7,X0) & plus_1(X3,X5,X4))),
  inference(true_and_false_elimination,[],[f88])).
tff(f88,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Integer_0()',X2 : 'Integer_0()',X3 : 'Integer_0()',X4 : 'Integer_0()',X5 : 'Integer_0()',X6 : 'Integer_0()',X7 : 'Integer_0()'] : ((diseqInteger_0(X2,X3) & plus_1(X1,X6,X7) & times_1(X2,X1,X0) & times_1(X5,X6,X0) & times_1(X4,X7,X0) & plus_1(X3,X5,X4)) => $false)),
  inference(rectify,[],[f43])).
tff(f43,axiom,(
  ! [X7 : 'Integer_0()',X0 : 'Integer_0()',X1 : 'Integer_0()',X4 : 'Integer_0()',X3 : 'Integer_0()',X2 : 'Integer_0()',X5 : 'Integer_0()',X6 : 'Integer_0()'] : ((diseqInteger_0(X1,X4) & plus_1(X0,X5,X6) & times_1(X1,X0,X7) & times_1(X2,X5,X7) & times_1(X3,X6,X7) & plus_1(X4,X2,X3)) => $false)),
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/tip2015/int_right_distrib.smt2',unknown)).
tff(f8639,plain,(
  sP10('P_1'(succ_0(zero_0)),'N_0'(succ_0(zero_0)),'N_0'(zero_0))),
  inference(unit_resulting_resolution,[],[f244,f7722,f197])).
tff(f7722,plain,(
  times_1('P_1'(succ_0(succ_0(zero_0))),'N_0'(succ_0(zero_0)),'N_0'(zero_0))),
  inference(unit_resulting_resolution,[],[f145,f1049,f569,f210])).
tff(f1049,plain,(
  sP15('N_0'(zero_0),'N_0'(succ_0(zero_0)),succ_0(succ_0(zero_0)))),
  inference(unit_resulting_resolution,[],[f280,f1035,f207])).
tff(f1035,plain,(
  sP13(succ_0(succ_0(zero_0)),'N_0'(succ_0(zero_0)),succ_0(zero_0))),
  inference(unit_resulting_resolution,[],[f280,f841,f203])).
tff(f841,plain,(
  times_0(succ_0(succ_0(zero_0)),succ_0(succ_0(zero_0)),succ_0(zero_0))),
  inference(unit_resulting_resolution,[],[f269,f770,f166])).
tff(f244,plain,(
...
tff(f9,axiom,(
  ...
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/tip2015/int_right_distrib.smt2',unknown)).
tff(f7770,plain,(
  ( ! [X0 : 'Nat_0()',X1 : 'Nat_0()'] : (sP11('P_1'(zero_0),'N_0'(succ_0(X0)),'N_0'(X1),'N_0'(X0))) )),
  inference(unit_resulting_resolution,[],[f6567,f7713,f199])).
tff(f7713,plain,(
  ( ! [X0 : 'Nat_0()'] : (times_1('P_1'(zero_0),'P_1'(zero_0),'N_0'(X0))) )),
  inference(unit_resulting_resolution,[],[f129,f560,f568,f210])).
tff(f568,plain,(
  ( ! [X0 : 'Nat_0()',X1 : 'Nat_0()'] : (sP16('Neg_0','N_0'(X0),'P_1'(X1))) )),
  inference(unit_resulting_resolution,[],[f134,f546,f209])).
tff(f546,plain,(
  ( ! [X0 : 'Nat_0()'] : (sP14('Neg_0','N_0'(X0),'Pos_0')) )),
  inference(unit_resulting_resolution,[],[f135,f143,f205])).
tff(f143,plain,(
  ( ! [X0 : 'Sign_0()'] : (timesSign_0(X0,'Pos_0',X0)) )),
...
tff(f23,axiom,(
  ...
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/tip2015/int_right_distrib.smt2',unknown)).
tff(f560,plain,(
  ( ! [X0 : 'Nat_0()'] : (sP15('N_0'(X0),'P_1'(zero_0),zero_0)) )),
  inference(unit_resulting_resolution,[],[f280,f542,f207])).
tff(f542,plain,(
  ( ! [X0 : 'Nat_0()'] : (sP13(zero_0,'P_1'(zero_0),X0)) )),
  inference(unit_resulting_resolution,[],[f141,f142,f203])).
tff(f141,plain,(
