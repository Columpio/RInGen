...
tff(f2902,plain,(
  $false),
  inference(unit_resulting_resolution,[],[f75,f143,f134,f91])).
tff(f91,plain,(
  ( ! [X2 : 'Nat_0()',X0 : 'Integer_0()',X3 : 'Nat_0()',X1 : 'Nat_0()'] : (plus_1(X0,'P_1'(X2),'N_0'(X1)) | ~plus_0(X3,succ_0(zero_0),X1) | ~x_1(X0,X2,X3)) )),
  inference(cnf_transformation,[],[f61])).
tff(f61,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Nat_0()',X2 : 'Nat_0()',X3 : 'Nat_0()'] : (plus_1(X0,'P_1'(X2),'N_0'(X1)) | ~plus_0(X3,succ_0(zero_0),X1) | ~x_1(X0,X2,X3))),
  inference(flattening,[],[f60])).
tff(f60,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Nat_0()',X2 : 'Nat_0()',X3 : 'Nat_0()'] : (plus_1(X0,'P_1'(X2),'N_0'(X1)) | (~plus_0(X3,succ_0(zero_0),X1) | ~x_1(X0,X2,X3)))),
  inference(ennf_transformation,[],[f43])).
tff(f43,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Nat_0()',X2 : 'Nat_0()',X3 : 'Nat_0()'] : ((plus_0(X3,succ_0(zero_0),X1) & x_1(X0,X2,X3)) => plus_1(X0,'P_1'(X2),'N_0'(X1)))),
  inference(rectify,[],[f24])).
tff(f24,axiom,(
  ! [X0 : 'Integer_0()',X2 : 'Nat_0()',X3 : 'Nat_0()',X1 : 'Nat_0()'] : ((plus_0(X1,succ_0(zero_0),X2) & x_1(X0,X3,X1)) => plus_1(X0,'P_1'(X3),'N_0'(X2)))),
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/tip2015/int_add_ident_left.smt2',unknown)).
tff(f134,plain,(
  ( ! [X0 : 'Nat_0()'] : (~plus_1('N_0'(succ_0(X0)),'P_1'(zero_0),'N_0'(zero_0))) )),
  inference(unit_resulting_resolution,[],[f115,f64,f87])).
tff(f87,plain,(
  ( ! [X2 : 'Integer_0()',X0 : 'Integer_0()',X1 : 'Integer_0()'] : (~plus_1(X1,X0,X2) | ~zero_1(X0) | ~diseqInteger_0(X2,X1)) )),
  inference(cnf_transformation,[],[f54])).
tff(f54,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Integer_0()',X2 : 'Integer_0()'] : (~diseqInteger_0(X2,X1) | ~zero_1(X0) | ~plus_1(X1,X0,X2))),
  inference(ennf_transformation,[],[f39])).
tff(f39,plain,(
  ! [X0 : 'Integer_0()',X1 : 'Integer_0()',X2 : 'Integer_0()'] : ~(diseqInteger_0(X2,X1) & zero_1(X0) & plus_1(X1,X0,X2))),
  inference(true_and_false_elimination,[],[f26])).
tff(f26,axiom,(
  ! [X0 : 'Integer_0()',X1 : 'Integer_0()',X2 : 'Integer_0()'] : ((diseqInteger_0(X2,X1) & zero_1(X0) & plus_1(X1,X0,X2)) => $false)),
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/tip2015/int_add_ident_left.smt2',unknown)).
tff(f64,plain,(
  zero_1('P_1'(zero_0))),
