...
tff(f123,plain,(
  $false),
  inference(unit_resulting_resolution,[],[f42,f75,f75,f50])).
tff(f50,plain,(
  ( ! [X2 : 'list_0()',X0 : 'Nat_0()',X3 : 'list_0()',X1 : 'list_0()'] : (~drop_0(X3,X0,X2) | ~diseqlist_0(X1,X2) | ~drop_0(X1,X0,X3)) )),
  inference(cnf_transformation,[],[f32])).
tff(f32,plain,(
  ! [X0 : 'Nat_0()',X1 : 'list_0()',X2 : 'list_0()',X3 : 'list_0()'] : (~diseqlist_0(X1,X2) | ~drop_0(X3,X0,X2) | ~drop_0(X1,X0,X3))),
  inference(ennf_transformation,[],[f27])).
tff(f27,plain,(
  ! [X0 : 'Nat_0()',X1 : 'list_0()',X2 : 'list_0()',X3 : 'list_0()'] : ~(diseqlist_0(X1,X2) & drop_0(X3,X0,X2) & drop_0(X1,X0,X3))),
  inference(true_and_false_elimination,[],[f26])).
tff(f26,plain,(
  ! [X0 : 'Nat_0()',X1 : 'list_0()',X2 : 'list_0()',X3 : 'list_0()'] : ((diseqlist_0(X1,X2) & drop_0(X3,X0,X2) & drop_0(X1,X0,X3)) => $false)),
  inference(rectify,[],[f18])).
tff(f18,axiom,(
  ! [X2 : 'Nat_0()',X1 : 'list_0()',X3 : 'list_0()',X0 : 'list_0()'] : ((diseqlist_0(X1,X3) & drop_0(X0,X2,X3) & drop_0(X1,X2,X0)) => $false)),
  file('/home/columpio/RiderProjects/RInGen/Tests/tests/generated/OriginalSolve/TIP.FreeSorts/false/productive_use_of_failure_drop_invol.smt2',unknown)).
tff(f75,plain,(
