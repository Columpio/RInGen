...
(assert (forall ((x_34 Bin_0))
	(projZeroAnd_1 x_34 (ZeroAnd_0 x_34))))
(assert (forall ((x_36 Bin_0))
	(projOneAnd_1 x_36 (OneAnd_0 x_36))))
(assert (isOne_0 One_0))
(assert (forall ((x_38 Bin_0))
	(isZeroAnd_0 (ZeroAnd_0 x_38))))
(assert (forall ((x_39 Bin_0))
	(isOneAnd_0 (OneAnd_0 x_39))))
...
(assert (forall ((x_48 Bin_0) (x_49 Bin_0))
	(=> (diseqBin_0 x_48 x_49)
	    (diseqBin_0 (ZeroAnd_0 x_48) (ZeroAnd_0 x_49)))))
(assert (forall ((x_50 Bin_0) (x_51 Bin_0))
	(=> (diseqBin_0 x_50 x_51)
	    (diseqBin_0 (OneAnd_0 x_50) (OneAnd_0 x_51)))))
