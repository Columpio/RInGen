...
(assert (forall ((x_29 Bin_0))
	(projZeroAnd_1 x_29 (ZeroAnd_0 x_29))))
(assert (forall ((x_31 Bin_0))
	(projOneAnd_1 x_31 (OneAnd_0 x_31))))
(assert (isOne_0 One_0))
(assert (forall ((x_33 Bin_0))
	(isZeroAnd_0 (ZeroAnd_0 x_33))))
(assert (forall ((x_34 Bin_0))
	(isOneAnd_0 (OneAnd_0 x_34))))
...
(assert (forall ((x_43 Bin_0) (x_44 Bin_0))
	(=> (diseqBin_0 x_43 x_44)
	    (diseqBin_0 (ZeroAnd_0 x_43) (ZeroAnd_0 x_44)))))
(assert (forall ((x_45 Bin_0) (x_46 Bin_0))
	(=> (diseqBin_0 x_45 x_46)
	    (diseqBin_0 (OneAnd_0 x_45) (OneAnd_0 x_46)))))
