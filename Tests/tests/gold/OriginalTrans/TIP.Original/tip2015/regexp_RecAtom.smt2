...
(assert (forall ((x_2099 A_0))
	(projAtom_1 x_2099 (Atom_0 x_2099))))
(assert (forall ((x_2101 R_0) (x_2102 R_0))
	(projPlus_2 x_2101 (Plus_0 x_2101 x_2102))))
(assert (forall ((x_2101 R_0) (x_2102 R_0))
	(projPlus_3 x_2102 (Plus_0 x_2101 x_2102))))
(assert (forall ((x_2104 R_0) (x_2105 R_0))
	(projSeq_2 x_2104 (Seq_0 x_2104 x_2105))))
(assert (forall ((x_2104 R_0) (x_2105 R_0))
	(projSeq_3 x_2105 (Seq_0 x_2104 x_2105))))
(assert (forall ((x_2107 R_0))
	(projStar_1 x_2107 (Star_0 x_2107))))
(assert (isNil_0 Nil_0))
(assert (isEps_0 Eps_0))
(assert (forall ((x_2109 A_0))
	(isAtom_0 (Atom_0 x_2109))))
(assert (forall ((x_2110 R_0) (x_2111 R_0))
	(isPlus_0 (Plus_0 x_2110 x_2111))))
(assert (forall ((x_2112 R_0) (x_2113 R_0))
	(isSeq_0 (Seq_0 x_2112 x_2113))))
(assert (forall ((x_2114 R_0))
	(isStar_0 (Star_0 x_2114))))
(assert (diseqR_0 Nil_0 Eps_0))
(assert (forall ((x_2115 A_0))
	(diseqR_0 Nil_0 (Atom_0 x_2115))))
(assert (forall ((x_2116 R_0) (x_2117 R_0))
	(diseqR_0 Nil_0 (Plus_0 x_2116 x_2117))))
(assert (forall ((x_2118 R_0) (x_2119 R_0))
	(diseqR_0 Nil_0 (Seq_0 x_2118 x_2119))))
(assert (forall ((x_2120 R_0))
	(diseqR_0 Nil_0 (Star_0 x_2120))))
(assert (diseqR_0 Eps_0 Nil_0))
(assert (forall ((x_2121 A_0))
	(diseqR_0 (Atom_0 x_2121) Nil_0)))
(assert (forall ((x_2122 R_0) (x_2123 R_0))
	(diseqR_0 (Plus_0 x_2122 x_2123) Nil_0)))
(assert (forall ((x_2124 R_0) (x_2125 R_0))
	(diseqR_0 (Seq_0 x_2124 x_2125) Nil_0)))
(assert (forall ((x_2126 R_0))
	(diseqR_0 (Star_0 x_2126) Nil_0)))
(assert (forall ((x_2127 A_0))
	(diseqR_0 Eps_0 (Atom_0 x_2127))))
(assert (forall ((x_2128 R_0) (x_2129 R_0))
	(diseqR_0 Eps_0 (Plus_0 x_2128 x_2129))))
(assert (forall ((x_2130 R_0) (x_2131 R_0))
	(diseqR_0 Eps_0 (Seq_0 x_2130 x_2131))))
(assert (forall ((x_2132 R_0))
	(diseqR_0 Eps_0 (Star_0 x_2132))))
(assert (forall ((x_2133 A_0))
	(diseqR_0 (Atom_0 x_2133) Eps_0)))
(assert (forall ((x_2134 R_0) (x_2135 R_0))
	(diseqR_0 (Plus_0 x_2134 x_2135) Eps_0)))
(assert (forall ((x_2136 R_0) (x_2137 R_0))
	(diseqR_0 (Seq_0 x_2136 x_2137) Eps_0)))
(assert (forall ((x_2138 R_0))
	(diseqR_0 (Star_0 x_2138) Eps_0)))
(assert (forall ((x_2139 A_0) (x_2140 R_0) (x_2141 R_0))
	(diseqR_0 (Atom_0 x_2139) (Plus_0 x_2140 x_2141))))
(assert (forall ((x_2142 A_0) (x_2143 R_0) (x_2144 R_0))
	(diseqR_0 (Atom_0 x_2142) (Seq_0 x_2143 x_2144))))
(assert (forall ((x_2145 A_0) (x_2146 R_0))
	(diseqR_0 (Atom_0 x_2145) (Star_0 x_2146))))
(assert (forall ((x_2147 R_0) (x_2148 R_0) (x_2149 A_0))
	(diseqR_0 (Plus_0 x_2147 x_2148) (Atom_0 x_2149))))
(assert (forall ((x_2150 R_0) (x_2151 R_0) (x_2152 A_0))
	(diseqR_0 (Seq_0 x_2150 x_2151) (Atom_0 x_2152))))
(assert (forall ((x_2153 R_0) (x_2154 A_0))
	(diseqR_0 (Star_0 x_2153) (Atom_0 x_2154))))
(assert (forall ((x_2155 R_0) (x_2156 R_0) (x_2157 R_0) (x_2158 R_0))
	(diseqR_0 (Plus_0 x_2155 x_2156) (Seq_0 x_2157 x_2158))))
(assert (forall ((x_2159 R_0) (x_2160 R_0) (x_2161 R_0))
	(diseqR_0 (Plus_0 x_2159 x_2160) (Star_0 x_2161))))
(assert (forall ((x_2162 R_0) (x_2163 R_0) (x_2164 R_0) (x_2165 R_0))
	(diseqR_0 (Seq_0 x_2162 x_2163) (Plus_0 x_2164 x_2165))))
(assert (forall ((x_2166 R_0) (x_2167 R_0) (x_2168 R_0))
	(diseqR_0 (Star_0 x_2166) (Plus_0 x_2167 x_2168))))
(assert (forall ((x_2169 R_0) (x_2170 R_0) (x_2171 R_0))
	(diseqR_0 (Seq_0 x_2169 x_2170) (Star_0 x_2171))))
(assert (forall ((x_2172 R_0) (x_2173 R_0) (x_2174 R_0))
	(diseqR_0 (Star_0 x_2172) (Seq_0 x_2173 x_2174))))
(assert (forall ((x_2175 A_0) (x_2176 A_0))
	(=> (diseqA_0 x_2175 x_2176)
	    (diseqR_0 (Atom_0 x_2175) (Atom_0 x_2176)))))
(assert (forall ((x_2177 R_0) (x_2178 R_0) (x_2179 R_0) (x_2180 R_0))
	(=> (diseqR_0 x_2177 x_2179)
	    (diseqR_0 (Plus_0 x_2177 x_2178) (Plus_0 x_2179 x_2180)))))
(assert (forall ((x_2177 R_0) (x_2178 R_0) (x_2179 R_0) (x_2180 R_0))
	(=> (diseqR_0 x_2178 x_2180)
	    (diseqR_0 (Plus_0 x_2177 x_2178) (Plus_0 x_2179 x_2180)))))
(assert (forall ((x_2181 R_0) (x_2182 R_0) (x_2183 R_0) (x_2184 R_0))
	(=> (diseqR_0 x_2181 x_2183)
	    (diseqR_0 (Seq_0 x_2181 x_2182) (Seq_0 x_2183 x_2184)))))
(assert (forall ((x_2181 R_0) (x_2182 R_0) (x_2183 R_0) (x_2184 R_0))
	(=> (diseqR_0 x_2182 x_2184)
	    (diseqR_0 (Seq_0 x_2181 x_2182) (Seq_0 x_2183 x_2184)))))
(assert (forall ((x_2185 R_0) (x_2186 R_0))
	(=> (diseqR_0 x_2185 x_2186)
	    (diseqR_0 (Star_0 x_2185) (Star_0 x_2186)))))
...
(assert (forall ((x_2188 A_0) (x_2189 list_0))
	(head_1 x_2188 (cons_0 x_2188 x_2189))))
(assert (forall ((x_2188 A_0) (x_2189 list_0))
	(tail_1 x_2189 (cons_0 x_2188 x_2189))))
(assert (isnil_1 nil_1))
(assert (forall ((x_2191 A_0) (x_2192 list_0))
	(iscons_0 (cons_0 x_2191 x_2192))))
(assert (forall ((x_2193 A_0) (x_2194 list_0))
	(diseqlist_0 nil_1 (cons_0 x_2193 x_2194))))
(assert (forall ((x_2195 A_0) (x_2196 list_0))
	(diseqlist_0 (cons_0 x_2195 x_2196) nil_1)))
(assert (forall ((x_2197 A_0) (x_2198 list_0) (x_2199 A_0) (x_2200 list_0))
	(=> (diseqA_0 x_2197 x_2199)
	    (diseqlist_0 (cons_0 x_2197 x_2198) (cons_0 x_2199 x_2200)))))
(assert (forall ((x_2197 A_0) (x_2198 list_0) (x_2199 A_0) (x_2200 list_0))
	(=> (diseqlist_0 x_2198 x_2200)
	    (diseqlist_0 (cons_0 x_2197 x_2198) (cons_0 x_2199 x_2200)))))
...
(assert (forall ((x_2042 Bool_0) (x_2043 Bool_0) (x_2044 Bool_0) (y_5 A_0) (ys_0 list_0) (x_12 A_0) (xs_0 list_0))
	(=>	(and (eqA_0 x_2043 x_12 y_5)
			(eqList_0 x_2044 xs_0 ys_0)
			(and_0 x_2042 x_2043 x_2044))
		(eqList_0 x_2042 (cons_0 x_12 xs_0) (cons_0 y_5 ys_0)))))
...
(assert (forall ((x_2049 Bool_0) (x_2050 Bool_0) (x_2051 Bool_0) (r_1 R_0) (q_1 R_0))
	(=>	(and (eps_1 x_2050 r_1)
			(eps_1 x_2051 q_1)
			(and_0 x_2049 x_2050 x_2051))
		(eps_1 x_2049 (Seq_0 r_1 q_1)))))
(assert (forall ((x_2052 Bool_0) (x_2053 Bool_0) (x_2054 Bool_0) (p_0 R_0) (q_0 R_0))
	(=>	(and (eps_1 x_2053 p_0)
			(eps_1 x_2054 q_0)
			(or_0 x_2052 x_2053 x_2054))
		(eps_1 x_2052 (Plus_0 p_0 q_0)))))
...
(assert (forall ((x_2060 Bool_0) (x_15 R_0))
	(=>	(and (diseqBool_0 x_2060 true_0)
			(eps_1 x_2060 x_15))
		(epsR_0 Nil_0 x_15))))
(declare-fun step_0 (R_0 R_0 A_0) Bool)
(assert (forall ((x_2062 R_0) (x_2063 R_0) (p_2 R_0) (y_7 A_0))
	(=>	(and (step_0 x_2063 p_2 y_7)
			(seq_1 x_2062 x_2063 (Star_0 p_2)))
		(step_0 x_2062 (Star_0 p_2) y_7))))
(assert (forall ((x_2065 R_0) (x_2066 R_0) (x_2067 R_0) (x_2068 R_0) (x_2069 R_0) (x_2070 R_0) (r_2 R_0) (q_3 R_0) (y_7 A_0))
	(=>	(and (step_0 x_2066 r_2 y_7)
			(seq_1 x_2067 x_2066 q_3)
			(epsR_0 x_2068 r_2)
			(step_0 x_2069 q_3 y_7)
			(seq_1 x_2070 x_2068 x_2069)
			(plus_1 x_2065 x_2067 x_2070))
		(step_0 x_2065 (Seq_0 r_2 q_3) y_7))))
(assert (forall ((x_2072 R_0) (x_2073 R_0) (x_2074 R_0) (p_1 R_0) (q_2 R_0) (y_7 A_0))
	(=>	(and (step_0 x_2073 p_1 y_7)
			(step_0 x_2074 q_2 y_7)
			(plus_1 x_2072 x_2073 x_2074))
		(step_0 x_2072 (Plus_0 p_1 q_2) y_7))))
(assert (forall ((a_1 A_0) (y_7 A_0))
	(=> (eqA_0 true_0 a_1 y_7)
	    (step_0 Eps_0 (Atom_0 a_1) y_7))))
(assert (forall ((x_2078 Bool_0) (a_1 A_0) (y_7 A_0))
	(=>	(and (diseqBool_0 x_2078 true_0)
			(eqA_0 x_2078 a_1 y_7))
		(step_0 Nil_0 (Atom_0 a_1) y_7))))
...
(assert (forall ((x_2082 Bool_0) (x_2083 R_0) (z_1 A_0) (xs_1 list_0) (x_18 R_0))
	(=>	(and (step_0 x_2083 x_18 z_1)
			(recognise_0 x_2082 x_2083 xs_1))
		(recognise_0 x_2082 x_18 (cons_0 z_1 xs_1)))))
(assert (forall ((x_2085 Bool_0) (x_18 R_0))
	(=> (eps_1 x_2085 x_18)
	    (recognise_0 x_2085 x_18 nil_1))))
(assert (forall ((x_2087 Bool_0) (x_2088 Bool_0) (a_2 A_0) (s_0 list_0))
	(=>	(and (diseqBool_0 x_2087 x_2088)
			(recognise_0 x_2087 (Atom_0 a_2) s_0)
			(eqList_0 x_2088 s_0 (cons_0 a_2 nil_1)))
		false)))
(check-sat)
