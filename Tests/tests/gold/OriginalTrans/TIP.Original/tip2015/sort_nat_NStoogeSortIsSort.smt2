...
(assert (forall ((z_5 Nat_0) (xs_1 list_0) (x_8 Nat_0))
	(=> (leq_0 true_0 x_8 z_5)
	    (insert_0 (cons_0 x_8 (cons_0 z_5 xs_1)) x_8 (cons_0 z_5 xs_1)))))
(assert (forall ((x_66 list_0) (x_64 Bool_0) (z_5 Nat_0) (xs_1 list_0) (x_8 Nat_0))
	(=>	(and (diseqBool_0 x_64 true_0)
			(insert_0 x_66 x_8 xs_1)
			(leq_0 x_64 x_8 z_5))
		(insert_0 (cons_0 z_5 x_66) x_8 (cons_0 z_5 xs_1)))))
...
(assert (forall ((x_68 list_0) (x_69 list_0) (y_9 Nat_0) (xs_2 list_0))
	(=>	(and (isort_0 x_69 xs_2)
			(insert_0 x_68 y_9 x_69))
		(isort_0 x_68 (cons_0 y_9 xs_2)))))
(assert (isort_0 nil_0 nil_0))
(declare-fun drop_0 (list_0 Nat_0 list_0) Bool)
(assert (forall ((x_72 list_0) (z_7 Nat_0) (xs_3 list_0) (z_6 Nat_0))
	(=> (drop_0 x_72 z_6 xs_3)
	    (drop_0 x_72 (succ_0 z_6) (cons_0 z_7 xs_3)))))
...
(assert (forall ((x_77 list_0) (x_78 list_0) (x_11 Nat_0) (y_11 list_0))
	(=>	(and (take_0 x_77 x_11 y_11)
			(drop_0 x_78 x_11 y_11))
		(splitAt_0 (pair_1 x_77 x_78) x_11 y_11))))
(declare-fun x_12 (list_0 list_0 list_0) Bool)
(assert (forall ((x_80 list_0) (z_8 Nat_0) (xs_4 list_0) (y_12 list_0))
	(=> (x_12 x_80 xs_4 y_12)
	    (x_12 (cons_0 z_8 x_80) (cons_0 z_8 xs_4) y_12))))
...
(assert (forall ((x_82 list_0) (x_83 list_0) (y_13 Nat_0) (xs_5 list_0))
	(=>	(and (reverse_0 x_83 xs_5)
			(x_12 x_82 x_83 (cons_0 y_13 nil_0)))
		(reverse_0 x_82 (cons_0 y_13 xs_5)))))
...
(assert (forall ((x_90 list_0) (x_91 list_0) (x_92 list_0) (x_86 Nat_0) (x_87 Nat_0) (x_88 list_0) (ys_0 list_0) (zs_0 list_0) (x_18 list_0))
	(=>	(and (nstoogesort_1 x_91 zs_0)
		...
		(nstoogesort_0 x_90 x_18))))
(assert (forall ((x_94 list_0) (x_95 list_0) (x_96 list_0) (x_21 Nat_0) (x_22 list_0) (y_15 Nat_0) (y_14 Nat_0))
	(=>	(and (nstoogesort_0 x_95 (cons_0 y_14 (cons_0 y_15 (cons_0 x_21 x_22))))
			(nstoogesort_2 x_96 x_95)
			(nstoogesort_0 x_94 x_96))
		(nstoogesort_1 x_94 (cons_0 y_14 (cons_0 y_15 (cons_0 x_21 x_22)))))))
(assert (forall ((x_98 list_0) (y_15 Nat_0) (y_14 Nat_0))
	(=> (sort_0 x_98 y_14 y_15)
	    (nstoogesort_1 x_98 (cons_0 y_14 (cons_0 y_15 nil_0))))))
