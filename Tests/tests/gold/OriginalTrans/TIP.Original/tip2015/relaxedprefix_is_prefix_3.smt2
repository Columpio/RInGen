...
(assert (forall ((x_38 It_0) (x_39 list_0))
...
(assert (forall ((x_47 It_0) (x_48 list_0) (x_49 It_0) (x_50 list_0))
	(=> (diseqIt_0 x_47 x_49)
...
(assert (forall ((x_28 list_0) (x_29 list_0) (x_30 Bool_0) (x_12 It_0) (xs_1 list_0) (ys_0 list_0))
	(=>	(and (diseqBool_0 x_30 true_0)
			(x_10 x_28 xs_1 (cons_0 x_12 nil_0))
			(x_10 x_29 xs_1 ys_0)
			(isRelaxedPrefix_0 x_30 x_28 x_29))
		false)))
(check-sat)
