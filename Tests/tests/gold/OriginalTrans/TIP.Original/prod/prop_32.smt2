...
(assert (forall ((r_0 Nat_1) (x_20 Nat_1) (y_3 Nat_1))
	(=> (add_0 r_0 x_20 y_3)
	    (add_0 (Z_4 r_0) (Z_4 x_20) y_3))))
(assert (forall ((y_3 Nat_1))
	(minus_0 Z_3 Z_3 y_3)))
(assert (forall ((r_0 Nat_1) (x_20 Nat_1) (y_3 Nat_1))
	(=> (minus_0 r_0 x_20 y_3)
	    (minus_0 (Z_4 r_0) (Z_4 x_20) y_3))))
(assert (forall ((y_3 Nat_1))
	(le_0 Z_3 y_3)))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (le_0 x_20 y_3)
	    (le_0 (Z_4 x_20) (Z_4 y_3)))))
(assert (forall ((y_3 Nat_1))
	(ge_0 y_3 Z_3)))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (ge_0 x_20 y_3)
	    (ge_0 (Z_4 x_20) (Z_4 y_3)))))
(assert (forall ((y_3 Nat_1))
	(lt_0 Z_3 (Z_4 y_3))))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_20 y_3)
	    (lt_0 (Z_4 x_20) (Z_4 y_3)))))
(assert (forall ((y_3 Nat_1))
	(gt_0 (Z_4 y_3) Z_3)))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (gt_0 x_20 y_3)
	    (gt_0 (Z_4 x_20) (Z_4 y_3)))))
(assert (forall ((y_3 Nat_1))
	(mult_0 Z_3 Z_3 y_3)))
(assert (forall ((r_0 Nat_1) (x_20 Nat_1) (y_3 Nat_1) (z_5 Nat_1))
	(=>	(and (mult_0 r_0 x_20 y_3)
			(add_0 z_5 r_0 y_3))
		(mult_0 z_5 (Z_4 x_20) y_3))))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_20 y_3)
	    (div_0 Z_3 x_20 y_3))))
(assert (forall ((r_0 Nat_1) (x_20 Nat_1) (y_3 Nat_1) (z_5 Nat_1))
	(=>	(and (ge_0 x_20 y_3)
			(minus_0 z_5 x_20 y_3)
			(div_0 r_0 z_5 y_3))
		(div_0 (Z_4 r_0) x_20 y_3))))
(assert (forall ((x_20 Nat_1) (y_3 Nat_1))
	(=> (lt_0 x_20 y_3)
	    (mod_0 x_20 x_20 y_3))))
(assert (forall ((r_0 Nat_1) (x_20 Nat_1) (y_3 Nat_1) (z_5 Nat_1))
