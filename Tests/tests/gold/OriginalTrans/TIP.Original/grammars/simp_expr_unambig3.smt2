...
(assert (forall ((x_24 Tok_0) (x_25 list_0))
	(head_1 x_24 (cons_0 x_24 x_25))))
(assert (forall ((x_24 Tok_0) (x_25 list_0))
	(tail_1 x_25 (cons_0 x_24 x_25))))
(assert (isnil_0 nil_0))
(assert (forall ((x_27 Tok_0) (x_28 list_0))
...
(assert (forall ((x_33 Tok_0) (x_34 list_0) (x_35 Tok_0) (x_36 list_0))
	(=> (diseqTok_0 x_33 x_35)
...
(assert (forall ((x_37 E_0) (x_38 E_0))
	(projPlus_2 x_37 (Plus_0 x_37 x_38))))
(assert (forall ((x_37 E_0) (x_38 E_0))
	(projPlus_3 x_38 (Plus_0 x_37 x_38))))
(assert (forall ((x_42 E_0) (x_43 E_0))
	(isPlus_0 (Plus_0 x_42 x_43))))
(assert (isEX_0 EX_0))
(assert (isEY_0 EY_0))
...
(assert (forall ((x_52 E_0) (x_53 E_0) (x_54 E_0) (x_55 E_0))
	(=> (diseqE_0 x_52 x_54)
	    (diseqE_0 (Plus_0 x_52 x_53) (Plus_0 x_54 x_55)))))
(assert (forall ((x_52 E_0) (x_53 E_0) (x_54 E_0) (x_55 E_0))
	(=> (diseqE_0 x_53 x_55)
	    (diseqE_0 (Plus_0 x_52 x_53) (Plus_0 x_54 x_55)))))
...
(assert (forall ((x_10 list_0) (x_11 list_0) (x_12 list_0) (x_13 list_0) (x_14 list_0) (a_0 E_0) (b_0 E_0))
	(=>	(and (lin_0 x_10 a_0)
			(lin_0 x_11 b_0)
			(x_1 x_12 (cons_0 D_0 (cons_0 Pl_0 nil_0)) x_11)
			(x_1 x_13 x_10 x_12)
			(x_1 x_14 (cons_0 C_0 nil_0) x_13))
		(lin_0 x_14 (Plus_0 a_0 b_0)))))
