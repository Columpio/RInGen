...
(assert (forall ((A Lst) (B Nat) (C Nat) (D Lst) (E Nat))
  (=> (and (count C A B) (= D (cons C A)) (= E (S B))) (count C D E))))
(assert (forall ((A Nat) (B Lst) (C Nat) (D Lst) (E Nat))
  (=> (and (count C B E) (= D (cons A B)) (diseqNat C A)) (count C D E))))
(assert (forall ((A Nat) (B Lst) (C Lst) (D Nat) (E Lst) (F Nat))
  (=> (and (count D E F) (count D C A) (append B C E) (ge A (S F))) incorrect)))
