...
(declare-fun filtergtz (Lst Lst) Bool)
...
(assert (forall ((A Lst) (B Lst))
  (=> (and (= B nil) (= A nil)) (filtergtz A B))))
(assert (forall ((A Nat) (B Lst) (C Lst) (D Lst) (E Lst))
  (=> (and (filtergtz B C) (= E (cons A C)) (= D (cons A B)) (gt A Z))
      (filtergtz D E))))
(assert (forall ((A Nat) (B Lst) (C Lst) (D Lst))
  (=> (and (filtergtz B D) (= C (cons A B)) (le A Z)) (filtergtz C D))))
(assert (forall ((A Lst)
         (B Lst)
         (C Lst)
         (D Lst)
