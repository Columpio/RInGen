...
(assert (forall ((x Lst) (y Lst) (xy Lst) (xyr Lst) (yr Lst) (xr Lst) (yrxr Lst) (k Nat))
	(=> (and (append x y xy) (rev xy xyr) (rev y yr) (rev x xr) (append yr xr yrxr) (= xyr (cons k yrxr))) false)))		;;;
