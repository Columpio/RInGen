...
(assert (forall ((x Lst) (y Lst) (xy Queue) (xl Nat) (yl Nat) (xyl Nat) (xlyl Nat)) (=> (and (amortizeQueue x y xy) (qlen xy xyl) (len x xl) (len y yl) (add xl yl xlyl) (= (S xyl) xlyl)) false)))
(check-sat)
